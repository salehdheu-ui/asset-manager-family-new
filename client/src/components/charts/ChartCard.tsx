    ...
    >
      ...
      <div className="relative mb-5 flex items-center justify-between gap-3">
        <div className="space-y-2">
          ...
          <div className="h-1 w-16 rounded-full bg-gradient-to-r from-primary/50 via-fund-in-bright/24 to-transparent" />
        </div>
        {icon && (
          <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-br from-primary/10 to-fund-in-bright/5 text-primary shadow-md ring-1 ring-primary/10">
            {icon}
          </div>
        )}
      </div>
